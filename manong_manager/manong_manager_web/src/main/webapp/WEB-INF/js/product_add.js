var MN = MANONG = {
    initProductCategory: function () {
        function loadSubCategories(value) {
            ...
            $.getJSON("/product_category/list",{id:value},function(data){
                ...
                $("#productAddForm").find("select[name='cid2']").combobox({
                    onChange: function() {
                        ...
                        console.log(value);
                        if(value == 0){
                            $("#productAddForm").find("input[name='categoryId']").val($("#productAddForm").find("select[name='cid1']").val());
                        }else{
        ...
        $("#productAddForm").find("select[id='cc']").combobox({
            onChange: function() {
                var value=$("#cc").val();
                $("#productAddForm").find("input[name='categoryId']").val(value);
        ...
        $(".uploadPic").click(function () {
            $.ajaxFileUpload({
                ...
                success:function (data) {
                    ...
                    $("#img").attr("src","http://192.168.194.110:8888/" +$(data).find("body").text());
